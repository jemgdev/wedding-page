...
export const guest = (() => {
  ...
  const buildGoogleCalendar = () => {
    ...
    const data = new URLSearchParams({
      action: "TEMPLATE",
      text: "La boda de Josué y Valentina",
      dates: `${formatDate("2026-05-01 18:00")}/${formatDate(
        "2026-05-01 21:00"
      )}`,
      details:
        "Estás cordialmente invitado a nuestra boda. Nos encantaría contar con tu presencia en este día tan especial para nosotros.",
      location: "Francisco Navarrete 909, Tumbes 24001",
      ctz: "Peru Standard Time",
    });
